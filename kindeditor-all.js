...
(function (window, undefined) {
	...
	K.options = {
		...
		htmlTags : {
			...
			video : ['poster','src','controls','width','height'],
	...
	function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
		var arr = [
			...
			'img.ke-video {',
			'	border:1px solid #AAA;',
			'	background-image:url(' + themesPath + 'common/video.gif);',
			'	background-position:center center;',
			'	background-repeat:no-repeat;',
...
KindEditor.lang({
	...
	invalidPoster : "请输入有效的封面URL地址。\n只允许http或https开头。",
	invalidVideoType : "video标签视频类暂时支持mp4，audio格式",
