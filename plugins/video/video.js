    ...
    self.plugin.video = {
        edit: function () {
            var html = [
                ...
                //poster
                '<div class="ke-dialog-row">',
                '<label for="keWidth" style="width:60px;">' + lang.poster + '</label>',
                '<input type="text" id="kePoster" class="ke-input-text" name="poster" value=""  style="width:400px;" placeholder="可以为空。"/>',
                '</div>',
                //width
                '<div class="ke-dialog-row">',
                ...
                '<input type="text" id="keHeight" class="ke-input-text ke-input-number" name="height" value="180" maxlength="4" />',
                '</div>',
                //autostart
                '<div class="ke-dialog-row">',
            ...
            var dialog = self.createDialog({
                    ...
                    yesBtn: {
                        ...
                        click: function (e) {
                            ...
                            var html = K.mediaImg(self.themesPath + 'common/blank.gif', attrs);
